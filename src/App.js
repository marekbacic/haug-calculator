...
function App() {
  ...
  const initializeFirebaseData = async () => {
    try {
      ...
      if (usersSnapshot.empty) {
        ...
        // Lista predefiniowanych użytkowników
        ...
        // Dodaj użytkowników do Firebase Auth i Firestore
        for (const user of predefinedUsers) {
          try {
            ...
            // Jeśli użytkownik już istnieje, po prostu kontynuuj
      ...
      // Dodaj przykładowe produkty, jeśli jeszcze nie istnieją
      ...
      if (authUser) {
        try {
          ...
          if (userDoc.exists()) {
            ...
            // Ustaw stan aktualnego użytkownika
            setCurrentUser({
              id: authUser.uid,
            ...
            // Zapamiętaj użytkownika w localStorage
  ...
  const ClientManagement = () => {
    ...
    return (
      <div>
        <h2 className="text-xl font-bold mb-4">Wszyscy Klienci</h2>
              ...
              <>
                <div className="bg-white p-4 rounded-lg shadow-sm mb-4">
                  ...
                  <div className="text-sm text-gray-500 mt-1">
                    Data utworzenia: {selectedClient.createdAt ? new Date(selectedClient.createdAt).toLocaleDateString() : '-'}
                  </div>
                </div>
          ...
          <div className="mt-4 md:mt-0">
            {currentUser ? (
              <div className="flex items-center space-x-4">
                <span className="text-gray-700">Zalogowany jako: <strong>{currentUser.username}</strong> ({currentUser.role === 'admin' ? 'Administrator' : 'Handlowiec'})</span>
                <button
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
              ...
              <div className="mt-4 text-center text-sm text-gray-500">
                <p>Dane logowania użytkowników:</p>
                <p>Admin: admin@haug.com / admin123</p>
                <p>Pawel: pawel@haug.com / pawel123</p>
                <p>Mateusz: mateusz@haug.com / mateusz123</p>
                <p>Mariusz: mariusz@haug.com / mariusz123</p>
                <p>Tomek: tomek@haug.com / tomek123</p>
              </div>
            </div>
          </div>
        )}
